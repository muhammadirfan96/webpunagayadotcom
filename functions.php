...
//$db = mysqli_connect("localhost", "root", "", "webpunagayadotcom");
...
function simpan($data) {
	...
	$jawaban1 = $data["flexRadioDefault1"];$coment1 = htmlspecialchars($data["textarea1"]);$jawaban2 = $data["flexRadioDefault2"];$coment2 = htmlspecialchars($data["textarea2"]);
	$jawaban3 = $data["flexRadioDefault3"];$coment3 = htmlspecialchars($data["textarea3"]);$jawaban4 = $data["flexRadioDefault4"];$coment4 = htmlspecialchars($data["textarea4"]);
	$jawaban5 = $data["flexRadioDefault5"];$coment5 = htmlspecialchars($data["textarea5"]);$jawaban6 = $data["flexRadioDefault6"];$coment6 = htmlspecialchars($data["textarea6"]);
	$jawaban7 = $data["flexRadioDefault7"];$coment7 = htmlspecialchars($data["textarea7"]);$jawaban8 = $data["flexRadioDefault8"];$coment8 = htmlspecialchars($data["textarea8"]);
	$jawaban9 = $data["flexRadioDefault9"];$coment9 = htmlspecialchars($data["textarea9"]);$jawaban10 = $data["flexRadioDefault10"];$coment10 = htmlspecialchars($data["textarea10"]);
	$jawaban11 = $data["flexRadioDefault11"];$coment11 = htmlspecialchars($data["textarea11"]);$jawaban12 = $data["flexRadioDefault12"];$coment12 = htmlspecialchars($data["textarea12"]);
	$jawaban13 = $data["flexRadioDefault13"];$coment13 = htmlspecialchars($data["textarea13"]);$jawaban14 = $data["flexRadioDefault14"];$coment14 = htmlspecialchars($data["textarea14"]);
	$jawaban15 = $data["flexRadioDefault15"];$coment15 = htmlspecialchars($data["textarea15"]);$jawaban16 = $data["flexRadioDefault16"];$coment16 = htmlspecialchars($data["textarea16"]);
	$jawaban17 = $data["flexRadioDefault17"];$coment17 = htmlspecialchars($data["textarea17"]);$jawaban18 = $data["flexRadioDefault18"];$coment18 = htmlspecialchars($data["textarea18"]);
	$jawaban19 = $data["flexRadioDefault19"];$coment19 = htmlspecialchars($data["textarea19"]);$jawaban20 = $data["flexRadioDefault20"];$coment20 = htmlspecialchars($data["textarea20"]);
	$jawaban21 = $data["flexRadioDefault21"];$coment21 = htmlspecialchars($data["textarea21"]);$jawaban22 = $data["flexRadioDefault22"];$coment22 = htmlspecialchars($data["textarea22"]);
	$jawaban23 = $data["flexRadioDefault23"];$coment23 = htmlspecialchars($data["textarea23"]);$jawaban24 = $data["flexRadioDefault24"];$coment24 = htmlspecialchars($data["textarea24"]);
	$jawaban25 = $data["flexRadioDefault25"];$coment25 = htmlspecialchars($data["textarea25"]);$jawaban26 = $data["flexRadioDefault26"];$coment26 = htmlspecialchars($data["textarea26"]);
	$jawaban27 = $data["flexRadioDefault27"];$coment27 = htmlspecialchars($data["textarea27"]);$jawaban28 = $data["flexRadioDefault28"];$coment28 = htmlspecialchars($data["textarea28"]);
	$jawaban29 = $data["flexRadioDefault29"];$coment29 = htmlspecialchars($data["textarea29"]);$jawaban30 = $data["flexRadioDefault30"];$coment30 = htmlspecialchars($data["textarea30"]);
	$jawaban31 = $data["flexRadioDefault31"];$coment31 = htmlspecialchars($data["textarea31"]);$jawaban32 = $data["flexRadioDefault32"];$coment32 = htmlspecialchars($data["textarea32"]);
	$jawaban33 = $data["flexRadioDefault33"];$coment33 = htmlspecialchars($data["textarea33"]);
...
function tambahLimaS($data){
	...
	$nilai1 = $data["nilai1"];$nilai2 = $data["nilai2"];$nilai3 = $data["nilai3"];$nilai4 = $data["nilai4"];$nilai5 = $data["nilai5"];
	$nilai6 = $data["nilai6"];$nilai7 = $data["nilai7"];$nilai8 = $data["nilai8"];$nilai9 = $data["nilai9"];$nilai10 = $data["nilai10"];
	$nilai11 = $data["nilai11"];$nilai12 = $data["nilai12"];$nilai13 = $data["nilai13"];$nilai14 = $data["nilai14"];$nilai15 = $data["nilai15"];
	$nilai16 = $data["nilai16"];$nilai17 = $data["nilai17"];$nilai18 = $data["nilai18"];$nilai19 = $data["nilai19"];$nilai20 = $data["nilai20"];
	$nilai21 = $data["nilai21"];$nilai22 = $data["nilai22"];$nilai23 = $data["nilai23"];$nilai24 = $data["nilai24"];$nilai25 = $data["nilai25"];
...
function simpanShutdown($data){
	...
	$jawaban0 = $data["jawaban0"];$waktu0 = $data["waktu0"];$ket0 = htmlspecialchars($data["ket0"]);
	$jawaban1 = $data["jawaban1"];$waktu1 = $data["waktu1"];$ket1 = htmlspecialchars($data["ket1"]);
	$jawaban2 = $data["jawaban2"];$waktu2 = $data["waktu2"];$ket2 = htmlspecialchars($data["ket2"]);
	$jawaban3 = $data["jawaban3"];$waktu3 = $data["waktu3"];$ket3 = htmlspecialchars($data["ket3"]);
	$jawaban4 = $data["jawaban4"];$waktu4 = $data["waktu4"];$ket4 = htmlspecialchars($data["ket4"]);
	$jawaban5 = $data["jawaban5"];$waktu5 = $data["waktu5"];$ket5 = htmlspecialchars($data["ket5"]);
	$jawaban6 = $data["jawaban6"];$waktu6 = $data["waktu6"];$ket6 = htmlspecialchars($data["ket6"]);
	$jawaban7 = $data["jawaban7"];$waktu7 = $data["waktu7"];$ket7 = htmlspecialchars($data["ket7"]);
	$jawaban8 = $data["jawaban8"];$waktu8 = $data["waktu8"];$ket8 = htmlspecialchars($data["ket8"]);
	$jawaban9 = $data["jawaban9"];$waktu9 = $data["waktu9"];$ket9 = htmlspecialchars($data["ket9"]);
	$jawaban10 = $data["jawaban10"];$waktu10 = $data["waktu10"];$ket10 = htmlspecialchars($data["ket10"]);
	$jawaban11 = $data["jawaban11"];$waktu11 = $data["waktu11"];$ket11 = htmlspecialchars($data["ket11"]);
	$jawaban12 = $data["jawaban12"];$waktu12 = $data["waktu12"];$ket12 = htmlspecialchars($data["ket12"]);
	$jawaban13 = $data["jawaban13"];$waktu13 = $data["waktu13"];$ket13 = htmlspecialchars($data["ket13"]);
	$jawaban14 = $data["jawaban14"];$waktu14 = $data["waktu14"];$ket14 = htmlspecialchars($data["ket14"]);
	$jawaban15 = $data["jawaban15"];$waktu15 = $data["waktu15"];$ket15 = htmlspecialchars($data["ket15"]);
	$jawaban16 = $data["jawaban16"];$waktu16 = $data["waktu16"];$ket16 = htmlspecialchars($data["ket16"]);
	$jawaban17 = $data["jawaban17"];$waktu17 = $data["waktu17"];$ket17 = htmlspecialchars($data["ket17"]);
	$jawaban18 = $data["jawaban18"];$waktu18 = $data["waktu18"];$ket18 = htmlspecialchars($data["ket18"]);
	$jawaban19 = $data["jawaban19"];$waktu19 = $data["waktu19"];$ket19 = htmlspecialchars($data["ket19"]);
	$jawaban20 = $data["jawaban20"];$waktu20 = $data["waktu20"];$ket20 = htmlspecialchars($data["ket20"]);
	$jawaban21 = $data["jawaban21"];$waktu21 = $data["waktu21"];$ket21 = htmlspecialchars($data["ket21"]);
	$jawaban22 = $data["jawaban22"];$waktu22 = $data["waktu22"];$ket22 = htmlspecialchars($data["ket22"]);
	$jawaban23 = $data["jawaban23"];$waktu23 = $data["waktu23"];$ket23 = htmlspecialchars($data["ket23"]);
	$jawaban24 = $data["jawaban24"];$waktu23 = $data["waktu24"];$ket24 = htmlspecialchars($data["ket24"]);
	$jawaban25 = $data["jawaban25"];$waktu25 = $data["waktu25"];$ket25 = htmlspecialchars($data["ket25"]);
	$jawaban26 = $data["jawaban26"];$waktu26 = $data["waktu26"];$ket26 = htmlspecialchars($data["ket26"]);
	$jawaban27 = $data["jawaban27"];$waktu27 = $data["waktu27"];$ket27 = htmlspecialchars($data["ket27"]);
	$jawaban28 = $data["jawaban28"];$waktu28 = $data["waktu28"];$ket28 = htmlspecialchars($data["ket28"]);
	$jawaban29 = $data["jawaban29"];$waktu29 = $data["waktu29"];$ket29 = htmlspecialchars($data["ket29"]);
	$jawaban30 = $data["jawaban30"];$waktu30 = $data["waktu30"];$ket30 = htmlspecialchars($data["ket30"]);
	$jawaban31 = $data["jawaban31"];$waktu31 = $data["waktu31"];$ket31 = htmlspecialchars($data["ket31"]);
	$jawaban32 = $data["jawaban32"];$waktu32 = $data["waktu32"];$ket32 = htmlspecialchars($data["ket32"]);
	$jawaban33 = $data["jawaban33"];$waktu33 = $data["waktu33"];$ket33 = htmlspecialchars($data["ket33"]);
	...
	$peralatanGangguan1 = htmlspecialchars($data["peralatanGangguan1"]);$ketPeralatanGangguan1 = htmlspecialchars($data["ketPeralatanGangguan1"]);
	$peralatanGangguan2 = htmlspecialchars($data["peralatanGangguan2"]);$ketPeralatanGangguan2 = htmlspecialchars($data["ketPeralatanGangguan2"]);
	$peralatanGangguan3 = htmlspecialchars($data["peralatanGangguan3"]);$ketPeralatanGangguan3 = htmlspecialchars($data["ketPeralatanGangguan3"]);
	$peralatanGangguan4 = htmlspecialchars($data["peralatanGangguan4"]);$ketPeralatanGangguan4 = htmlspecialchars($data["ketPeralatanGangguan4"]);
	$peralatanGangguan5 = htmlspecialchars($data["peralatanGangguan5"]);$ketPeralatanGangguan5 = htmlspecialchars($data["ketPeralatanGangguan5"]);
	$peralatanGangguan6 = htmlspecialchars($data["peralatanGangguan6"]);$ketPeralatanGangguan6 = htmlspecialchars($data["ketPeralatanGangguan6"]);
	$peralatanGangguan7 = htmlspecialchars($data["peralatanGangguan7"]);$ketPeralatanGangguan7 = htmlspecialchars($data["ketPeralatanGangguan7"]);
	$peralatanGangguan8 = htmlspecialchars($data["peralatanGangguan8"]);$ketPeralatanGangguan8 = htmlspecialchars($data["ketPeralatanGangguan8"]);
	$peralatanGangguan9 = htmlspecialchars($data["peralatanGangguan9"]);$ketPeralatanGangguan9 = htmlspecialchars($data["ketPeralatanGangguan9"]);
	$peralatanGangguan10 = htmlspecialchars($data["peralatanGangguan10"]);$ketPeralatanGangguan10 = htmlspecialchars($data["ketPeralatanGangguan10"]);
	$peralatanGangguan11 = htmlspecialchars($data["peralatanGangguan11"]);$ketPeralatanGangguan11 = htmlspecialchars($data["ketPeralatanGangguan11"]);
	$peralatanGangguan12 = htmlspecialchars($data["peralatanGangguan12"]);$ketPeralatanGangguan12 = htmlspecialchars($data["ketPeralatanGangguan12"]);
	$peralatanGangguan13 = htmlspecialchars($data["peralatanGangguan13"]);$ketPeralatanGangguan13 = htmlspecialchars($data["ketPeralatanGangguan13"]);
	$peralatanGangguan14 = htmlspecialchars($data["peralatanGangguan14"]);$ketPeralatanGangguan14 = htmlspecialchars($data["ketPeralatanGangguan14"]);
	$peralatanGangguan15 = htmlspecialchars($data["peralatanGangguan15"]);$ketPeralatanGangguan15 = htmlspecialchars($data["ketPeralatanGangguan15"]);
