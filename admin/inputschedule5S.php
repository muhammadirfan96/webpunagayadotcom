...
if (isset($_POST["saveLimasBoiler"])) {
	if (inputschedulelimasboiler($_POST["limasBoiler"]) > 0 ) {

		echo("
				<script>
					alert('schedule 5S boiler berhasil ditambahkan');
		...
		echo("
				<script>
					...
					document.location.href = 'inputschedule5S.php';
				</script>				
			");
	}
}

if (isset($_POST["saveLimasTurbin"])) {
	if (inputschedulelimasturbin($_POST["limasTurbin"]) > 0 ) {

		echo("
				<script>
					alert('schedule 5S turbin berhasil ditambahkan');
					document.location.href = 'admin.php';
				</script>
			");
	} else {
...
if (isset($_POST["saveLimasAlba"])) {
	if (inputschedulelimasalba($_POST["limasAlba"]) > 0 ) {

		echo("
				<script>
					alert('schedule 5S alba berhasil ditambahkan');
					document.location.href = 'admin.php';
				</script>
			");
	} else {
...
<body>
    <div class="container-fluid-md">
		<div class="row text-center text-light">
			<div class="col text-capitalize">
				<h2 class="py-3" style="margin-bottom:0px;background-color:#100b70;border-bottom:3px solid #fc8b05;">input schedule 5S</h2>
			</div>
		</div>
		<div class="row mb-3">
			<div class="col">
    ...
    <script src="../js/jqueryinputschedulelimas.js"></script>
</body>
</html>